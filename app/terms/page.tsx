    ...
    <MarketingShell>
      ...
      <section className="space-y-4">
        ...
        <article className="glass-panel rounded-[28px] p-6">
          ...
          <p className="mt-3 text-sm leading-7 text-[#5f584f]">The free plan includes five generations per day per browser. Pro is offered at ${PRO_MONTHLY_PRICE_USD}/month in this launch configuration and removes that browser-based cap.</p>
        </article>
        <article className="glass-panel rounded-[28px] p-6">
