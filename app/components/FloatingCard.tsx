...
export function FloatingCard({ title, content, icon, delay = 0 }: FloatingCardProps) {
  return (
    <motion.article
      ...
      className="group relative overflow-hidden rounded-2xl border border-cyan-400/20 bg-slate-950/70 p-5 shadow-[0_0_35px_rgba(34,211,238,0.2)] backdrop-blur-xl"
    >
      <motion.div
        animate={{ y: [0, -8, 0] }}
        transition={{ duration: 5.5, repeat: Number.POSITIVE_INFINITY, ease: "easeInOut", delay }}
        className="absolute -top-10 -right-10 h-24 w-24 rounded-full bg-fuchsia-500/20 blur-2xl"
      />
